module.exports = class Data1687387880619 {
    name = 'Data1687387880619'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "token" ("id" character varying NOT NULL, "token_id" numeric NOT NULL, "last_retrieval" integer NOT NULL, "uri" text, "image" text, "attributes" jsonb, "owner_id" character varying, CONSTRAINT "PK_82fae97f905930df5d62a702fc9" PRIMARY KEY ("id"))`)
